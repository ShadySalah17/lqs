                    ...
                    <div class="ap-option-wrapper">
                        ...
                        <div class="ap-option-field">
                            <select name="form_styles[label][font_size]">
                                <option value=""><?php _e( 'Choose Font Size', 'anonymous-post-pro' ); ?></option>
                                <?php
                                for ( $i = 12; $i <= 30; $i = $i + 2 ) {
                                    ?>
            ...
            <div class="ap-form-styles">
                ...
                <div class="ap-tab-wrapper">
                    ...
                    <div class="ap-option-wrapper">
                        ...
                        <div class="ap-option-field">
                            <input type="text" name="form_styles[form][border_color]" class="ap-color-field" value="<?php if ( isset( $ap_settings[ 'form_styles' ][ 'form' ][ 'border_color' ] ) ) {
                                    echo esc_attr( $ap_settings[ 'form_styles' ][ 'form' ][ 'border_color' ] );
                                } ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="ap-option-wrapper">
                        ...
                        <div class="ap-option-field">
                            <input type="number" name="form_styles[form][border_thickness]" value="<?php if ( isset( $ap_settings[ 'form_styles' ][ 'form' ][ 'border_thickness' ] ) ) {
                                    echo esc_attr( $ap_settings[ 'form_styles' ][ 'form' ][ 'border_thickness' ] );
                                } ?>"/>
                        </div>
                    </div><!--ap-option-wrapper-->
