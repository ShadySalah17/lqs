		...
		$screen->add_help_tab( 
			array(
			    ...
			    'content'	=>
			    	...
			    	'<p>' . __( 'As of Name Your Price version 2.0, this ability is available for "Simple", "Subscription", "Mix and Match", "Composite", "Bundled", "Variable" and "Variable Subscriptions" Products.', 'wc_name_your_price' ) . '</p>' .
