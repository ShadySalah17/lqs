            ...
            <div class="wp-chatbot-footer">
                <div id="wp-chatbot-editor-container" class="wp-chatbot-editor-container">
                    ...
                    <input id="wp-chatbot-editor" class="wp-chatbot-editor" required
                           placeholder="<?php echo qcld_wpb_randmom_message_handle(@unserialize(get_option('qlcd_wp_chatbot_send_a_msg'))); ?>"
                    >
                    <button type="button" id="wp-chatbot-send-message"
                            class="wp-chatbot-button"><?php echo esc_html__('Send', 'wpchatbot'); ?></button>
                ...
                <div class="wp-chatbot-tab-nav">
                    ...
                    <?php if(get_option('enable_wp_chatbot_disable_chaticon')!='1'): ?>
                        <li class="wp-chatbot-operation-active"><a class="wp-chatbot-operation-option" data-option="chat" href="" title="<?php echo (get_option('qlcd_wp_chatbot_skip_conversation')?get_option('qlcd_wp_chatbot_skip_conversation'):'Click this button to skip the conversation'); ?>"></a></li>
                     <?php endif; ?>
                    </ul>
                </div>
                <?php endif; ?>
