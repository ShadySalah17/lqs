            ...
            <div class="wp-chatbot-footer">
                ...
                <div class="wp-chatbot-tab-nav">
					...
					<ul>
                        ...
                        <li class="wp-chatbot-operation-active"><a class="wp-chatbot-operation-option" data-option="chat" href="" title="<?php echo (get_option('qlcd_wp_chatbot_skip_conversation')?get_option('qlcd_wp_chatbot_skip_conversation'):'Click this button to skip the conversation'); ?>" data-tooltip="bottom"></a></li>
                        <?php endif; ?>
                    </ul>
                </div>
                <?php endif; ?>
